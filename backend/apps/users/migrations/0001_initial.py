    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_password_change', models.DateTimeField(default=django.utils.timezone.now, verbose_name='último cambio de contraseña')),
                ('is_active', models.BooleanField(default=True, verbose_name='activo')),
                ('last_login_attempt', models.DateTimeField(blank=True, null=True, verbose_name='último intento de inicio de sesión')),
